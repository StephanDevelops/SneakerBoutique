...
<html lang="en">
  ...
  <head>
    ...
    <title>Sneaker Boutique Cart</title>
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="https://sneakerboutique.org"><h2>Sneaker <em>Boutique</em></h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active">
                <a class="nav-link" href="https://sneakerboutique.org">Home
    ...
    <div style="padding: 100px;" align="center">
        ...
        <table>
            ...
            <tr style="background-color: black;">
                ...
                <td style="padding: 10px; color: white;">
                <input type="text" name="price hidden[]" value="{{$carts->price}}" hidden>
